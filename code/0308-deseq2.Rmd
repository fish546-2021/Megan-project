...
write.table(DEG,"/Volumes/Samsung USB/Megan-project/analyses/0309-DEG.tab", row.names = T)
```
...
#make heatmap
pheatmap(DEGHeatmap, scale = "row",show_rownames = TRUE, treeheight_col = 1, fontsize_col = 12, fontsize_row = 5)
```
